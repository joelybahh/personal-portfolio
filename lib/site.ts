export const site = {
  ...
  description:
    "Joel Gabriel is a lead full-stack engineer with nearly a decade of experience across game, software and web development — building 3D web platforms, CMS systems and developer tooling.",
